...
const allUsers = asyncHandler(async(req,res) => {
    ...
    ? {
        $or: [
            // regex operator is used to search for the given string in the specified collection. It is helpful when we don’t know the exact field value that we are looking in the document. 
    ...
    //here we are eliminating the registered user from the keyword because he is the one who is searching
